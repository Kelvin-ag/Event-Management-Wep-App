...
<head>
    ...
    <title>Swift-Events| Organizer</title>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-4 px-5">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="organizer.php">Home</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="dashboard">
            ...
            <div class="d-flex align-items-start">
                <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <button class="nav-link" id="v-pills-manage-tab" data-bs-toggle="pill" data-bs-target="#v-pills-manage" type="button" role="tab" aria-controls="v-pills-manage" aria-selected="false">Manage Events</button>
                ...
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade show active" id="v-pills-account" role="tabpanel" aria-labelledby="v-pills-account-tab">
                        ...
                        echo "<tr>";
                        echo "<td>Company:</td>";
                        echo "<td>" . strtoupper(($data['company'])) . "</td>";
                        echo "</tr>";
                        echo "<tr>";
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th>Cover Image</th>
                                    <th>Organizer Action</th>
                                </tr>
                                <?php
                                while ($row = mysqli_fetch_array($eventRecord)) { ?>
                                    <tr>
                                        <td> <?php echo ucfirst(strtolower($row['event_name'])) ?> </td>
                                        <td> <?php echo ucfirst(strtolower($row['event_location'])) ?> </td>
                                        <td> <?php echo ucfirst(strtolower($row['event_start'])) ?> </td>
                                        <td> <?php echo ucfirst(strtolower($row['event_end'])) ?> </td>
                                        <?php echo "<td> <img src='" . $row['event_img'] . "'> </td>" ?>
                                        <!-- update, delete, and view events -->
                                        <td valign="middle"><a id="adminEdit" href="createEvent.php?edit=<?php echo $row['event_ID']; ?>">Update</a>
                                            <a id="adminDel" title="Delete Event" href="connect.php?delete=<?php echo $row['event_ID']; ?>">Delete</a>
                                            <a id="viewEvent" href="viewEvent.php?view=<?php echo $events['user_ID']; ?>">View</a>
                                        </td>
                                    </tr>
                                <?php
                                }
